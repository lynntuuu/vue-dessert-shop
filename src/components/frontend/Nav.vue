      ...
      <div class="container">
        ...
        <h1 class="text-hide mb-0">
          <router-link class="navbar-brand mx-0 py-0 py-md-1" to="/index">
            ...
            <img class="d-none d-md-inline-block" src="@/assets/images/logo_2@3x.png"
              style="height:32px;">
          </router-link>菓實日
        </h1>
        <div class="collapse navbar-collapse justify-content-end order-2"
        ...
        <div class="nav-item dropdown cart-icon order-md-2">
          <a class="nav-link dropdown-toggle pulse-animated" :class="{ 'bounce-animated': addAnimated}"
          ...
          <div class="dropdown-menu dropdown-menu-right px-2" aria-labelledby="navbarDropdown">
            ...
            <div v-else>
              ...
              <router-link to="/cart" class="btn btn-secondary w-100 text-white mt-2">
                查看我的購物車
              </router-link>
            </div>
          </div>
      ...
      <div class="carousel-inner vw-100">
        <div class="carousel-item active mw-100 vh-100 d-flex">
          <div class="carousel-content container">
            <p class="mb-0 text-light px-3">製菓、真實、日常</p>
            <h2 class="mt-2">
              菓實日
            </h2>
