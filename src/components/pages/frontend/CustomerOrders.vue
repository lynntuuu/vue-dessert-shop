<template>
  <div>
    <div class="container p-3 p-md-4">
      <h2 class="title">建立訂單</h2>
      <div class="row mb-5">
        <div class="col-sm-4">
          <div class="alert alert-deep-yellow rounded-pill text-center" role="alert">1.填寫訂單</div>
        </div>
        <div class="col-sm-4">
      ...
      <ValidationObserver ref="form" class="my-5 row justify-content-center">
        <form class="mx-auto col-12 col-md-8" @submit.prevent="creatOrder">
          ...
          <div class="text-right">
            <button class="btn btn-deep-yellow text-white">確認送出訂單</button>
          </div>
        </form>
      </ValidationObserver>
    </div>
