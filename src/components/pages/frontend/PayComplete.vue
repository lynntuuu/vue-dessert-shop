    ...
    <div class="container p-3 p-md-4">
      ...
      <div class="my-6 text-center border">
          ...
          <table class="table table-borderless mx-auto col-10 col-md-6 col-lg-4 text-left">
            <tbody>
              <tr>
                ...
                <td class="align-middle p-1 text-danger">{{order.create_at | date}}</td>
              </tr>
              <tr>
        ...
        <div class="text-gray-700">
          ...
          <p class="mb-1">為了保持產品新鮮，菓實日堅持新鮮現做，請您耐心等候。</p>
          <p class="mb-4">如有其它變更需求，請致電客服0800-000-000將有專員為您服務。</p>
        </div>
      </div>
      <div class="my-4 text-center">
        <router-link to="/products" class="btn btn-deep-yellow text-white py-2">
          繼續選購
