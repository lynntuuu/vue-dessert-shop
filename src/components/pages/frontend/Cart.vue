    ...
    <div class="container p-3 p-md-4">
      ...
      <div class="my-4" v-if="cart.total">
            ...
            <tr class="d-md-none">
              <td colspan="5">
                <div class="input-group input-group-sm mr-auto w-100">
                  <input type="text" class="form-control" placeholder="請輸入 discount 看看" v-model="couponCode">
        ...
        <div class="text-right">
          <router-link to="/customer_orders" class="py-2 btn btn-deep-yellow text-white m-md-0 mr-2">
            確認訂單，前往下一步
