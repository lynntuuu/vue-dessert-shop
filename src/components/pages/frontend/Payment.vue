<template>
  <div>
    <div class="container p-3 p-md-4">
      <h2 class="title">訂單付款</h2>
      <div class="row mb-5">
        <div class="col-sm-4">
          <div class="alert alert-deep-yellow rounded-pill text-center" role="alert">
            1.填寫訂單
            <font-awesome-icon icon="check" class="ml-2" />
          </div>
        </div>
        <div class="col-sm-4">
          <div class="alert alert-deep-yellow rounded-pill text-center" role="alert">2.確認付款</div>
        </div>
        <div class="col-sm-4">
      ...
      <div class="my-4 row">
        <table class="table border mx-auto col-10 col-md-8">
          <thead class="bg-gray-100" style="border-top: 5px solid #c99659">
            <tr>
      ...
      <div class="my-4 row justify-content-center">
        <div class="text-right col-10 col-md-8 px-0">
            <button class="btn btn-deep-yellow text-white"
